...
--> statement-breakpoint
ALTER TABLE "billing_records" DROP CONSTRAINT "billing_records_delivery_item_id_unique";--> statement-breakpoint
ALTER TABLE "billing_records" ADD COLUMN "mode_delivery" text;--> statement-breakpoint
ALTER TABLE "billing_records" ADD COLUMN "no_resi" text;--> statement-breakpoint
ALTER TABLE "billing_records" ADD COLUMN "status_delivery" text;--> statement-breakpoint
ALTER TABLE "billing_records" ADD COLUMN "scan_inv_url" text;--> statement-breakpoint
...
ALTER TABLE "billing_records" ADD CONSTRAINT "billing_records_po_no_unique" UNIQUE("po_no");