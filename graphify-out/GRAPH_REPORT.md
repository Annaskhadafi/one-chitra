...
## Corpus Check
- 1275 files · ~1,119,423 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5025 nodes · 6880 edges · 122 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 1579 edges (avg confidence: 0.8)
...
1. `getAuthenticatedSession()` - 271 edges
2. `String()` - 193 edges
...
- `fetchRate()` --calls--> `getSetting()`  [INFERRED]
  quotation-form-backup.tsx → app\actions\settings.ts
...
Cohesion: 0.01
Nodes (226): AccountPage(), addWorkflowStep(), buildFormOptionFromRoute(), collectDashboardRoutes(), collectModuleFiles(), compareByOperator(), createApprovalDefinition(), createApprovalOrgNode() (+218 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (152): getAllSalesRevenueData(), getDashboardInventory(), getDashboardRevenueForecast(), getPct(), getRevenueReportConfig(), fetchAllSalesRevenueData(), fetchDashboardInventory(), fetchDashboardRevenueForecast() (+144 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (140): getBundlingFormDependencies(), getCustomers(), completeEvhsDraftVoucher(), confirmEvhsReceipt(), createEvhsDraftVoucher(), createEvhsVoucher(), createGiRecord(), deleteEvhsVoucher() (+132 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (84): getFleetList(), acknowledgeNotification(), addDaysToDate(), addMonthsToDate(), average(), buildConfidenceNote(), buildMonthlySeries(), calculateLinearTrendSlope() (+76 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (87): updateDeliveryDate(), createFleetTrip(), deleteFleetTrip(), generateTripNumber(), updateFleetTrip(), updateFleetTripStatus(), createSurveyForm(), createSurveyFormFromTemplate() (+79 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (77): buildFallbackMonthlyReportInsight(), createCompetitorActivity(), createCompetitorPrice(), createLostSale(), generateCompetitorMonthlyReportInsight(), getCompetitorActivities(), getCompetitorPrices(), getLostSales() (+69 more)
...
Cohesion: 0.03
Nodes (77): assertOriginWarehouseStock(), buildDeliveryItemQuantityMap(), buildDeliveryStockCheckResult(), bulkAttachDoScansByInternalNo(), bulkDeleteDeliveries(), bulkUpdateDeliveryStatus(), checkStockAvailability(), clearLogisticsCosts() (+69 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (75): attachSalesDocumentsToQuotation(), buildComparableQuotationItems(), buildCustomerPoAttachmentTitle(), buildExtractedDataFromOcr(), buildMappedDataFromOcr(), buildOcrFailureSummary(), buildQuotationSnapshot(), bulkDeleteQuotations() (+67 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (85): updateDoMonitoringFields(), getNavbarMenuSettingsAction(), resetNavbarMenuSettingsAction(), saveNavbarMenuSettingsAction(), getNavbarThemeAction(), isValidHexColor(), resetNavbarThemeAction(), revalidateNavbarThemePaths() (+77 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (57): deleteBusinessCard(), getBusinessCards(), scanAndSaveBusinessCard(), updateBusinessCard(), createSettlement(), deleteSettlement(), generateSettlementNumber(), getLatestSettlementByDeliveryIds() (+49 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (67): extractInternalNo(), forceDeliveryYear2026(), normalizeInternalNo(), POST(), sanitizeText(), selectDisplayText(), callMistralChat(), callOllamaChat() (+59 more)
...
Cohesion: 0.05
Nodes (53): askHelpDeskOllama(), buildKnowledgeDraftFromDocument(), deleteHelpDeskKnowledgeSource(), ensureBotUser(), ensureHelpDeskKnowledgeSeed(), ensureHelpDeskRoom(), extractHelpDeskKnowledgeFromDocument(), generateHelpDeskReply() (+45 more)
...
Cohesion: 0.05
Nodes (33): createCosmeticTire(), deleteCosmeticTire(), ensureCosmeticTiresTable(), getCosmeticTires(), importCosmeticTires(), normalizeInput(), updateCosmeticTire(), deleteSlowMovingProduct() (+25 more)
...
Cohesion: 0.07
Nodes (32): deriveCustomerSegments(), findBestCustomerMatch(), formatDateOnly(), getCustomerCampaignLaunchContext(), getCustomerMarketingInsight(), getCustomerOrderHistory(), getHistoryOrderForSegmentation(), getMarketingSegmentCustomerInsights() (+24 more)
...
Cohesion: 0.08
Nodes (29): createTirePerformanceRecord(), deleteTirePerformanceRecord(), ensureTirePerformanceTable(), getTirePerformanceRecords(), importTirePerformanceRecords(), normalizeInput(), normalizeNumeric(), updateTirePerformanceRecord() (+21 more)
...
Cohesion: 0.21
Nodes (16): buildDeliveryDocumentStatus(), buildDeliveryPriority(), buildLastActivity(), buildOrderDocumentStatus(), buildOrderPriority(), compactDateLabel(), formatIsoDate(), getCustomer360Data() (+8 more)
...
Cohesion: 0.17
Nodes (13): getOcrStatusMap(), getVendorQuotationById(), mapToSerializable(), normalizeNullableText(), saveVendorQuotationDraft(), syncVendorQuotationsFromEpr(), triggerVendorQuotationOcr(), buildLatestGrManualByPo() (+5 more)

### Community 49 - "Community 49"
Cohesion: 0.16
Nodes (8): autoMatchCompetitorPrice(), calculateBundlingOptimization(), getMaxHistoricalPrice(), commit(), handleAddProduct(), handleBlur(), handleCalculate(), handleKeyDown()
...
Cohesion: 0.17
Nodes (9): createDriver(), createVehicle(), getDrivers(), getVehicles(), handleCreateDriver(), handleCreateVehicle(), isStaleServerActionError(), loadFleet() (+1 more)
...
Cohesion: 0.18
Nodes (7): calculateSellingPrice(), ceilToThousand(), createBundleGroupId(), createQuotationItemClientId(), fetchRate(), if(), setBlockedDialog()
...
Cohesion: 0.19
Nodes (6): calculateSellingPrice(), ceilToThousand(), createBundleGroupId(), createQuotationItemClientId(), if(), setBlockedDialog()
...
Cohesion: 0.29
Nodes (9): exportExcel(), exportPdf(), formatNumber(), formatPercent(), stockIndicator(), buildTopCustomerExportRows(), buildTopCustomerSummary(), buildTopProductExportRows() (+1 more)
...
Cohesion: 0.22
Nodes (5): buildBaseWhere(), getCustomerIndustryDashboard(), normName(), getCustomerTireHistory(), getMatGrpGroup()
...
Cohesion: 0.22
Nodes (3): formatCurrency(), formatRupiahAxis(), handleGenerateInsight()
...
- **Thin community `Community 88`** (7 nodes): `matrix-builder.tsx`, `addDraftNode()`, `handleSave()`, `makeTempId()`, `removeDraftNode()`, `updateDraftNode()`, `validateDraft()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (7 nodes): `getSafeCallbackUrl()`, `getSignInErrorMessage()`, `handleMagicLinkSignIn()`, `handleResetPasswordRequest()`, `handleSubmit()`, `initVanta()`, `auth-entry-screen.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (6 nodes): `filter-context.tsx`, `FilterProvider()`, `getDefaultFilters()`, `loadFiltersFromStorage()`, `saveFiltersToStorage()`, `useFilters()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (6 nodes): `stock-table.tsx`, `calculatePrice()`, `calculateValuation()`, `formatCurrency()`, `getBookingRemarkSummary()`, `getTotalBookingQty()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (6 nodes): `form-renderer.tsx`, `cn()`, `handleSubmit()`, `handleUploadAnswerFile()`, `toggleCheckbox()`, `updateAnswer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (5 nodes): `cover-letter-dialog.tsx`, `buildPrintHTML()`, `CoverLetterDialog()`, `formatDate()`, `formatDateLong()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (5 nodes): `getSerialNumberHistory()`, `serial-number.ts`, `page.tsx`, `SerialNumberContent()`, `SerialNumberHistoryPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (5 nodes): `event-detail-sheet.tsx`, `vendor-quotation-table.tsx`, `handleDelete()`, `formatCurrency()`, `onDelete()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (5 nodes): `PermissionGuard()`, `permission-guard.tsx`, `PermissionsProvider()`, `use-permissions.tsx`, `usePermissions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (3 nodes): `isPublicRoute()`, `proxy()`, `proxy.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 161`** (3 nodes): `getABCAnalysis()`, `getABCSummary()`, `abc-analysis.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 165`** (3 nodes): `getDashboardStats()`, `getRangeBounds()`, `dashboard.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 168`** (3 nodes): `route.ts`, `generateRandomString()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 171`** (3 nodes): `layout.tsx`, `layout.tsx`, `PrintLayout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 189`** (3 nodes): `layout.tsx`, `layout.tsx`, `PrintChecklistLayout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 206`** (3 nodes): `main()`, `splitSqlStatements()`, `apply-approval-migration.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (3 nodes): `main()`, `splitSqlStatements()`, `apply-approval-org-migration.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 208`** (3 nodes): `ensureMigrationTable()`, `main()`, `baseline-migrations.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 209`** (3 nodes): `main()`, `normalizedTextSql()`, `fix-stock-product-sloc-mismatch.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 210`** (3 nodes): `loadRepairCandidates()`, `main()`, `repair-delivery-qty-anomalies.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `String()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 48`, `Community 50`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 61`, `Community 62`, `Community 66`, `Community 68`, `Community 69`, `Community 70`, `Community 77`, `Community 78`, `Community 82`?**
  _High betweenness centrality (0.256) - this node is a cross-community bridge._
- **Why does `getAuthenticatedSession()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 27`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 35`, `Community 49`, `Community 60`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `checkPermission()` connect `Community 4` to `Community 0`, `Community 7`, `Community 9`, `Community 10`, `Community 18`, `Community 29`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Are the 268 inferred relationships involving `getAuthenticatedSession()` (e.g. with `getA2RCompetitionFilterOptions()` and `getA2RCompetitionTargetSetup()`) actually correct?**
  _`getAuthenticatedSession()` has 268 INFERRED edges - model-reasoned connections that need verification._
- **Are the 191 inferred relationships involving `String()` (e.g. with `main()` and `monthKey()`) actually correct?**
  _`String()` has 191 INFERRED edges - model-reasoned connections that need verification._
