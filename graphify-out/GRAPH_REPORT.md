# Graph Report - one-chitra  (2026-05-17)

## Corpus Check
- 1093 files · ~943,369 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4306 nodes · 5910 edges · 113 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 1329 edges (avg confidence: 0.8)
...
1. `getAuthenticatedSession()` - 231 edges
2. `String()` - 162 edges
...
Cohesion: 0.01
Nodes (236): AccountPage(), addWorkflowStep(), buildFormOptionFromRoute(), collectDashboardRoutes(), collectModuleFiles(), compareByOperator(), createApprovalDefinition(), createApprovalOrgNode() (+228 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (137): getBundlingFormDependencies(), getCustomers(), completeEvhsDraftVoucher(), confirmEvhsReceipt(), createEvhsDraftVoucher(), createEvhsVoucher(), createGiRecord(), deleteEvhsVoucher() (+129 more)
...
Cohesion: 0.02
Nodes (75): updateDoMonitoringFields(), attachSalesDocumentsToQuotation(), buildComparableQuotationItems(), buildCustomerPoAttachmentTitle(), buildExtractedDataFromOcr(), buildMappedDataFromOcr(), buildOcrFailureSummary(), buildQuotationSnapshot() (+67 more)
...
Cohesion: 0.03
Nodes (61): buildSalesOrderColumns(), bulkDeleteSalesOrders(), bulkUpdateSalesOrderStatus(), createSalesOrder(), deleteSalesOrder(), duplicateCustomerPoResult(), findExistingSalesOrderByCustomerPo(), generateInvoiceNumber() (+53 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (67): assertOriginWarehouseStock(), buildDeliveryItemQuantityMap(), buildDeliveryStockCheckResult(), bulkAttachDoScansByInternalNo(), bulkDeleteDeliveries(), bulkUpdateDeliveryStatus(), checkStockAvailability(), clearLogisticsCosts() (+59 more)
...
Cohesion: 0.12
Nodes (11): aggregate(), buildMonthlyBrandTrend(), buildSizeAnalysis(), cleanText(), getDatePresetRange(), median(), parseDateValue(), parseMoney() (+3 more)
...
Cohesion: 0.18
Nodes (10): cleanText(), csvUrl(), fetchSheet(), getField(), loadSheet(), parseActivity(), parseDateValue(), parseLostSale() (+2 more)
...
Cohesion: 0.15
Nodes (6): cleanText(), getDatePresetRange(), getField(), parseDateValue(), parseMoney(), toDateInputValue()
...
## Knowledge Gaps
- **Thin community `Community 68`** (10 nodes): `do-monitoring-table.tsx`, `calculateGrandTotal()`, `escapeCsvValue()`, `formatCurrency()`, `formatQuantity()`, `getDateRangePreset()`, `getDeliveryItemValue()`, `getMatchedDeliveryItems()`, `getWarehouseLabel()`, `if()`
...
- **Thin community `Community 81`** (7 nodes): `matrix-builder.tsx`, `addDraftNode()`, `handleSave()`, `makeTempId()`, `removeDraftNode()`, `updateDraftNode()`, `validateDraft()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (6 nodes): `operational-activity-log-table.tsx`, `actionColor()`, `applyFilters()`, `clearFilters()`, `goToPage()`, `tableLabel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (6 nodes): `filter-context.tsx`, `FilterProvider()`, `getDefaultFilters()`, `loadFiltersFromStorage()`, `saveFiltersToStorage()`, `useFilters()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (6 nodes): `sales-revenue-table.tsx`, `fmt()`, `formatDateCell()`, `handleExportExcel()`, `toggleCustomerName()`, `toggleSalesman()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 111`** (5 nodes): `cover-letter-dialog.tsx`, `buildPrintHTML()`, `CoverLetterDialog()`, `formatDate()`, `formatDateLong()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (5 nodes): `getPriceHistory()`, `price-list-items-view.tsx`, `handleDelete()`, `load()`, `onSubmit()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 151`** (3 nodes): `getABCAnalysis()`, `getABCSummary()`, `abc-analysis.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (3 nodes): `getDashboardStats()`, `getRangeBounds()`, `dashboard.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `String()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 39`, `Community 40`, `Community 41`, `Community 46`, `Community 47`, `Community 50`, `Community 51`, `Community 57`, `Community 61`, `Community 63`, `Community 68`, `Community 70`, `Community 74`, `Community 90`, `Community 96`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `getAuthenticatedSession()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 21`, `Community 23`, `Community 26`, `Community 29`, `Community 30`, `Community 34`, `Community 36`, `Community 37`, `Community 48`, `Community 55`, `Community 56`, `Community 66`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `onSuccess()` connect `Community 4` to `Community 1`, `Community 3`, `Community 7`, `Community 23`, `Community 24`, `Community 27`?**
