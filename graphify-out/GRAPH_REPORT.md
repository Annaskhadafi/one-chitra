...
## Corpus Check
- 1056 files · ~883,632 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4090 nodes · 5621 edges · 103 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 1291 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (180): AccountPage(), addWorkflowStep(), buildFormOptionFromRoute(), collectDashboardRoutes(), collectModuleFiles(), compareByOperator(), createApprovalDefinition(), createApprovalOrgNode() (+172 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (150): getBundlingFormDependencies(), getCustomers(), completeEvhsDraftVoucher(), confirmEvhsReceipt(), createEvhsDraftVoucher(), createEvhsVoucher(), createGiRecord(), deleteEvhsVoucher() (+142 more)
...
Cohesion: 0.03
Nodes (79): createFleetTrip(), deleteFleetTrip(), generateTripNumber(), updateFleetTrip(), updateFleetTripStatus(), createSurveyForm(), createSurveyFormFromTemplate(), deleteSurveyForm() (+71 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (63): assertOriginWarehouseStock(), buildDeliveryItemQuantityMap(), buildDeliveryStockCheckResult(), bulkAttachDoScansByInternalNo(), bulkUpdateDeliveryStatus(), checkStockAvailability(), clearLogisticsCosts(), createDelivery() (+55 more)
...
Cohesion: 0.03
Nodes (48): bulkUpdateDeliveryShipmentDetails(), duplicateQuotation(), checkTransferStockAvailability(), createStockTransfer(), getStockTransfers(), getStockTransferStats(), mergeTransferItemsByProduct(), syncStockTransferReceipt() (+40 more)
...
Cohesion: 0.11
Nodes (23): bulkDeleteMasterPrices(), createOrUpdateMasterPrice(), deleteMasterPrice(), getErrorMessage(), importMasterPrices(), buildDeliveryDocumentStatus(), buildDeliveryPriority(), buildLastActivity() (+15 more)
...
Cohesion: 0.09
Nodes (13): calculateSellingPrice(), ceilToThousand(), createBundleGroupId(), createQuotationItemClientId(), if(), setBlockedDialog(), handleFileUpload(), handleSubmit() (+5 more)
...
- **Thin community `Community 92`** (6 nodes): `form-renderer.tsx`, `cn()`, `handleSubmit()`, `handleUploadAnswerFile()`, `toggleCheckbox()`, `updateAnswer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (5 nodes): `getSerialNumberHistory()`, `serial-number.ts`, `page.tsx`, `SerialNumberContent()`, `SerialNumberHistoryPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `getAuthenticatedSession()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 18`, `Community 21`, `Community 26`, `Community 27`, `Community 28`, `Community 31`, `Community 32`, `Community 33`, `Community 49`, `Community 51`, `Community 57`?**
  _High betweenness centrality (0.230) - this node is a cross-community bridge._
- **Why does `String()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 41`, `Community 42`, `Community 44`, `Community 48`, `Community 54`, `Community 59`, `Community 61`, `Community 64`?**
  _High betweenness centrality (0.223) - this node is a cross-community bridge._
- **Why does `checkPermission()` connect `Community 6` to `Community 0`, `Community 3`, `Community 5`, `Community 7`, `Community 9`, `Community 26`?**
