...
The `ExportDialog` component provides a user-friendly interface for exporting ML Inventory Predictions to Excel or PDF formats with optional filtering capabilities.
...
import { ExportDialog } from "@/app/dashboard/inventory-ml/_components/export-dialog";
...
```
ML_Forecast_[Type]_[Date].[ext]
```

Examples:
- `ML_Forecast_All_2024-01-15.xlsx`
- `ML_Forecast_REPLENISHMENT_2024-01-15.pdf`
- `ML_Forecast_SAFETY_STOCK_2024-01-15.xlsx`
...
Run tests:
```bash
npm run test -- app/dashboard/inventory-ml/_components/__tests__/export-dialog.test.tsx
```
...
- `@/app/actions/inventory-ml`: Server actions for export
