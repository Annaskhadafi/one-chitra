...
**Filter Logic Tests (`inventory-ml-filters.test.ts`):**
...
**Performance Tests (`inventory-ml-filters-performance.test.ts`):**
...
npm test -- app/dashboard/inventory-ml/_components/__tests__/filter
...
npm test -- app/actions/__tests__/inventory-ml-filters --run
```
