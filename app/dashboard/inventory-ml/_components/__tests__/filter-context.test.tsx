...
describe("FilterContext - localStorage persistence", () => {
    ...
    it("should save filter state to localStorage", () => {
        ...
        localStorageMock.setItem("inventory-ml-filters", JSON.stringify(filters))

        const stored = localStorageMock.getItem("inventory-ml-filters")
    ...
    it("should load filter state from localStorage", () => {
        ...
        localStorageMock.setItem("inventory-ml-filters", JSON.stringify(storedFilters))

        const loaded = localStorageMock.getItem("inventory-ml-filters")
    ...
    it("should handle corrupted localStorage data gracefully", () => {
        localStorageMock.setItem("inventory-ml-filters", "invalid json {")
    ...
    it("should persist all filter types", () => {
        ...
        localStorageMock.setItem("inventory-ml-filters", JSON.stringify(complexFilters))
    ...
    it("should clear filters from localStorage", () => {
        ...
        localStorageMock.setItem("inventory-ml-filters", JSON.stringify(filters))
        expect(localStorageMock.getItem("inventory-ml-filters")).toBeTruthy()

        localStorageMock.removeItem("inventory-ml-filters")
        expect(localStorageMock.getItem("inventory-ml-filters")).toBeNull()
    })
    ...
    it("should handle default filter values", () => {
        ...
        localStorageMock.setItem("inventory-ml-filters", JSON.stringify(defaultFilters))
