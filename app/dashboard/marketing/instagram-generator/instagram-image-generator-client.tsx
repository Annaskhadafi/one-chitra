...
Variant note: Include a professional photo of a person wearing Chitra Paratama official safety workwear: a single integrated long sleeve hi-visibility work shirt, NOT a vest, with bright neon lime green upper chest/shoulders/upper arms, dark navy blue lower torso and lower sleeves, silver reflective tape across upper arms and around the torso at chest level, full button-down collar, two flap chest pockets on the neon green section, and a small Chitra Paratama logo patch on the left chest pocket integrated naturally into the design.`,
