...
Variant note: Include a professional photo of a person wearing Chitra Paratama official safety workwear (long sleeve two-tone shirt: upper chest/shoulders in neon lime green, lower body/sleeves in dark navy blue, silver reflective tape on upper arms and torso, button-down collar, left chest logo patch) integrated naturally into the design.`,
