...
function buildEnhancedPrompt(input: {
  ...
  return [
    ...
    "WAJIB: Jika ada sosok manusia (pekerja, mekanik, tim, operator), mereka HARUS memakai wearpack safety resmi PT Chitra Paratama: kemeja kerja lengan panjang TWO-TONE (BUKAN rompi/vest), area atas (dada/bahu/lengan atas) berwarna HIJAU NEON TERANG/Lime Green (#8DC63F), area bawah (perut/bawah lengan) berwarna BIRU NAVY GELAP (#002D56), ada PITA REFLEKTIF ABU-ABU/SILVER melingkari dada dan lengan atas, kerah kancing penuh, dua saku dada di area hijau, logo kecil di dada kiri.",
