...
function buildSystemPrompt() {
  return [
    ...
    "WAJIB: Jika prompt SECARA EKSPLISIT melibatkan orang, karyawan, teknisi, operator, tim lapangan, atau aktivitas yang membutuhkan kehadiran manusia, orang tersebut HARUS memakai baju dinas/wearpack safety PT Chitra Paratama dengan spesifikasi PRESISI berikut: kemeja kerja lengan panjang TWO-TONE (BUKAN rompi/vest terpisah), SELURUH LENGAN (atas dan bawah) berwarna BIRU NAVY GELAP (#002D56), area DADA dan BAHU berwarna HIJAU NEON TERANG/Lime Green (#8DC63F), ada STRIP REFLEKTIF SILVER di PUNDAK KANAN dan KIRI (horizontal di bahu), ada SATU GARIS REFLEKTIF HORIZONTAL di TENGAH PERUT tepat di batas antara area hijau atas dan biru navy bawah, kerah kancing penuh, dua saku dada di area hijau, logo kecil Chitra Paratama di dada kiri. Gunakan referensi logo dari https://www.chitraparatama.co.id/wp-content/uploads/2025/11/cp_logo-removebg-preview-e1767678002905.png sebagai patch dada kiri kecil yang natural seperti bordir/jahitan, bukan logo besar. JIKA input user tidak secara eksplisit memerlukan orang (misal hanya objek ban, gedung, grafis abstrak), MAKA JANGAN memaksakan memasukkan orang ke dalam prompt.",
