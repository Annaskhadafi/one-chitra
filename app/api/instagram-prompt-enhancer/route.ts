...
function buildSystemPrompt() {
  return [
    ...
    "WAJIB: Jika prompt melibatkan orang, karyawan, teknisi, operator, tim lapangan, safety, warehouse, workshop, ban, alat berat, atau aktivitas industrial, orang tersebut HARUS memakai baju dinas/wearpack safety PT Chitra Paratama dengan spesifikasi PRESISI berikut: Hi-visibility safety work shirt with long sleeves, TWO-TONE design (bukan vest/rompi), UPPER SECTION (chest, shoulders, upper arms) in BRIGHT NEON LIME GREEN / SAFETY YELLOW-GREEN (#8DC63F area), LOWER SECTION (lower torso, lower sleeves from elbow down) in DARK NAVY BLUE (#002D56), horizontal SILVER REFLECTIVE TAPE across upper arms and around torso at chest level, full button-down collar shirt (bukan zipper), TWO CHEST POCKETS with flaps on the neon lime green upper section, small Chitra Paratama logo patch on left chest pocket, professional industrial uniform style, NOT a vest over shirt but a single integrated two-tone shirt, front view or natural working angle, photo-realistic professional quality.",
